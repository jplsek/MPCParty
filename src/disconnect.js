...
return {
  ...
  callSocketClose: function () {
    ...
    setTimeout(function () {
      ...
      mpcp.lazyToast.error(msg + '<br>Retrying in <span id="count">1</span> second(s)... <button title="Force a retry" class="retry-server btn btn-warning pull-right"><i class="fas fa-redo"></i></button>', 'Server Disconnected!', 5000, false);
    }, 200);
